...
const LaptopDetails = () => {
  ...
  const features = [
    ...
    { label: 'پردازنده گرافیکی', value: product.gpu },
    { label: 'ظرفیت حافظه رم', value: product.ram },
    { label: 'ظرفیت حافظه داخلی', value: product.storage },
    { label: 'دقت صفحه نمایش', value: product.screen },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            <div className="md:col-span-2 p-4 sm:p-6">
              ...
              <div className=" flex flex-col items-end mt-3 sm:mt-4">
                ...
                <div className="flex content-start flex-col my-4 mt-5 sm:mt-6 w-[100%]">
